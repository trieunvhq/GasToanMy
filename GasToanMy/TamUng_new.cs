...
namespace GasToanMy
{
    public partial class TamUng_new : Form
    {
        ...
        private void HienThi_ThemMoi()
        {
            ...
            clsTamUng_New      cls = new GasToanMy.clsTamUng_New();
        ...
        private void Luu_ChiTiet_TamUng(int xxxID_TamUng)
        {
            ...
            {
                clsTamUng_ChiTietTamUng cls2 = new GasToanMy.clsTamUng_ChiTietTamUng();
                string shienthi = "1";
                ...
                for (int i = 0; i < dt_gridcontrol.Rows.Count; i++)
                {
                    ...
                    cls2 = new GasToanMy.clsTamUng_ChiTietTamUng();
