...
namespace GasToanMy
{
    public partial class GapDan_frmChiTietNhapXuatTon_MotVatTu : Form
    {
        ...
        {
            clsGapDan_ChiTiet_NhapKho cls = new GasToanMy.clsGapDan_ChiTiet_NhapKho();
        ...
        private void LoadDaTa(int xxID_VTHH___, DateTime xxtungay, DateTime xxdenngay)
        {
            ...
            clsGapDan_ChiTiet_NhapKho cls1 = new GasToanMy.clsGapDan_ChiTiet_NhapKho();
            ...
            cls1 = new GasToanMy.clsGapDan_ChiTiet_NhapKho();
