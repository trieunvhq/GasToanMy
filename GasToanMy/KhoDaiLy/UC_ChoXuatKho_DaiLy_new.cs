...
namespace GasToanMy
{
    public partial class UC_ChoXuatKho_DaiLy_new : UserControl
    {
        ...
        private void HienThiGridControl_2(int xxID_Xuatkho_)
        {
            ...
            clsDaiLy_tbChiTietXuatKho_Temp cls2 = new GasToanMy.clsDaiLy_tbChiTietXuatKho_Temp();          
        ...
        private void Luu_ThamCHieuTinhXuatKho(int iiiiID_XuatKhoDaiLy)
        {
            ...
            {
                clsDaiLy_ThamChieu_TinhXuatKho cls = new GasToanMy.clsDaiLy_ThamChieu_TinhXuatKho();
