...
namespace GasToanMy
{
    public partial class DaiLy_frmChiTietNhapXuatTon_MotVatTu : Form
    {
        ...
        private void Load_Lockup()
        {
            ...
            cls.Dispose();
            dt2.Dispose();
            clsDaiLy_tbNhapKho clsxx = new GasToanMy.clsDaiLy_tbNhapKho();
        ...
        private void LoadDaTa(int xxID_VTHH___, int xxID_DaiLy, DateTime xxtungay, DateTime xxdenngay)
        {
            ...
            clsDaiLy_tbChiTietNhapKho cls1 = new GasToanMy.clsDaiLy_tbChiTietNhapKho();
            ...
            cls1 = new GasToanMy.clsDaiLy_tbChiTietNhapKho();
