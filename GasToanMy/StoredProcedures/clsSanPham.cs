...
namespace GasToanMy
{
	...
	public partial class clsSanPham : clsDBInteractionBase
	{
		#region Class Member Declarations
			...
			private SqlDouble		m_fGiaVon, m_fGiaBan, m_fSoLuong;
			private SqlInt32		m_iID;
			private SqlString		m_sCreateUser, m_sPhanNhom, m_sUpdateUser, m_sCode, m_sDonViTinh, m_sNhaCungCap, m_sTenSanPham, m_sDescription;
		#endregion
		...
		///		 <LI>fGiaVon. May be SqlDouble.Null</LI>
		///		 <LI>fGiaBan. May be SqlDouble.Null</LI>
		...
		public override bool Insert()
		{
			...
			try
			{
				...
				scmCmdToExecute.Parameters.Add(new SqlParameter("@fGiaVon", SqlDbType.Float, 8, ParameterDirection.Input, false, 38, 0, "", DataRowVersion.Proposed, m_fGiaVon));
				scmCmdToExecute.Parameters.Add(new SqlParameter("@fGiaBan", SqlDbType.Float, 8, ParameterDirection.Input, false, 38, 0, "", DataRowVersion.Proposed, m_fGiaBan));
		...
		public override DataTable SelectOne()
		{
			...
			try
			{
				...
				if(dtToReturn.Rows.Count > 0)
				{
					...
					m_fGiaVon = dtToReturn.Rows[0]["GiaVon"] == System.DBNull.Value ? SqlDouble.Null : (double)dtToReturn.Rows[0]["GiaVon"];
					m_fGiaBan = dtToReturn.Rows[0]["GiaBan"] == System.DBNull.Value ? SqlDouble.Null : (double)dtToReturn.Rows[0]["GiaBan"];
		...
		public SqlDouble fGiaVon
		{
			...
			set
			{
				SqlDouble fGiaVonTmp = (SqlDouble)value;
				if(fGiaVonTmp.IsNull)
				{
					throw new ArgumentOutOfRangeException("fGiaVon", "fGiaVon can't be NULL");
				}
				m_fGiaVon = value;
			}
		}
		...
		public SqlDouble fGiaBan
		{
			...
			set
			{
				SqlDouble fGiaBanTmp = (SqlDouble)value;
				if(fGiaBanTmp.IsNull)
				{
					throw new ArgumentOutOfRangeException("fGiaBan", "fGiaBan can't be NULL");
				}
				m_fGiaBan = value;
			}
		}
