...
namespace GasToanMy
{
	...
	public partial class clsUsers : clsDBInteractionBase
	{
		...
		///		 <LI>sRole</LI>
		///		 <LI>sRecordStatus</LI>
		///		 <LI>daCreateDate</LI>#region Class Member Declarations
			private SqlString		m_sRecordStatus;
			private SqlDateTime		m_daCreateDate, m_daUpdateDate;
			private SqlInt32		m_iID;
			private SqlString		m_sRole, m_sUpdateUser, m_sCreateUser, m_sAcountName, m_sCode, m_sType, m_sEmail, m_sPhone, m_sPassword;
		#endregion


		/// <summary>
		/// Purpose: Class constru
		///		 <LI>sCreateUser</LI>
		///		 <LI>daUpdateDate</LI>
		///		 <LI>sUpdateUser</LI>
