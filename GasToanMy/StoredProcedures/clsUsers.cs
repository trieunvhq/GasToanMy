...
// Generated by LLBLGen v1.3.5996.26197 Final on: Sunday, March 27, 2022, 10:19:01 PM
...
namespace GasToanMy
{
	...
	public partial class clsUsers : clsDBInteractionBase
	{
		#region Class Member Declarations
			...
			private SqlString		m_sRole, m_sUpdateUser, m_sCreateUser, m_sAcountName, m_sCode, m_sCode_NhanSu, m_sEmail, m_sPhone, m_sPassword;
		#endregion
		...
		/// <UL>
		///		 <LI>sCode_NhanSu. May be SqlString.Null</LI>
		...
		public override bool Insert()
		{
			...
			try
			{
				scmCmdToExecute.Parameters.Add(new SqlParameter("@sCode_NhanSu", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, m_sCode_NhanSu));
		...
		public override DataTable SelectOne()
		{
			...
			try
			{
				...
				if(dtToReturn.Rows.Count > 0)
				{
					...
					m_sCode_NhanSu = dtToReturn.Rows[0]["Code_NhanSu"] == System.DBNull.Value ? SqlString.Null : (string)dtToReturn.Rows[0]["Code_NhanSu"];
		...
		public SqlString sCode_NhanSu
		{
			get
			{
				return m_sCode_NhanSu;
			}
			set
			{
				SqlString sCode_NhanSuTmp = (SqlString)value;
				if(sCode_NhanSuTmp.IsNull)
				{
					throw new ArgumentOutOfRangeException("sCode_NhanSu", "sCode_NhanSu can't be NULL");
				}
				m_sCode_NhanSu = value;
			}
		}
