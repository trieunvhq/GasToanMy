...
namespace GasToanMy
{
	...
	public class clsNhanSu : clsDBInteractionBase
	{
		#region Class Member Declarations
			...
			private SqlString		m_sDescription, m_sUpdateUser, m_sCreateUser, m_sChucVu, m_sFullName, m_sCode, m_sType, m_sEmail, m_sPhone, m_sAddress;
		#endregion
		...
		///		 <LI>sChucVu. May be SqlString.Null</LI>
		...
		public override bool Insert()
		{
			...
			try
			{
				...
				scmCmdToExecute.Parameters.Add(new SqlParameter("@sAddress", SqlDbType.NVarChar, 250, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, m_sAddress));
