...
// Generated by LLBLGen v1.3.5996.26197 Final on: Tuesday, April 5, 2022, 3:35:49 PM
...
namespace GasToanMy
{
	...
	public partial class clsDonHang : clsDBInteractionBase
	{
		#region Class Member Declarations
			...
			private SqlDouble		m_fTongTienDonHang, m_fTienDaThanhToan;
			private SqlInt32		m_iID;
			private SqlString		m_sPaymentStatus, m_sUpdateUser, m_sCreateUser, m_sCode, m_sType, m_sCodeKhachHang, m_sRecordStatus, m_sDescription;
		#endregion
		...
		///		 <LI>fTienDaThanhToan. May be SqlDouble.Null</LI>
		...
		public override DataTable SelectOne()
		{
			...
			try
			{
				...
				if(dtToReturn.Rows.Count > 0)
				{
					...
					m_fTienDaThanhToan = dtToReturn.Rows[0]["TienDaThanhToan"] == System.DBNull.Value ? SqlDouble.Null : (double)dtToReturn.Rows[0]["TienDaThanhToan"];
		...
		public SqlDouble fTienDaThanhToan
		{
			get
			{
				return m_fTienDaThanhToan;
			}
			set
			{
				SqlDouble fTienDaThanhToanTmp = (SqlDouble)value;
				if(fTienDaThanhToanTmp.IsNull)
				{
					throw new ArgumentOutOfRangeException("fTienDaThanhToan", "fTienDaThanhToan can't be NULL");
				}
				m_fTienDaThanhToan = value;
			}
		}
