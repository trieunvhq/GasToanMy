...
namespace GasToanMy
{
    public partial class UCQuy_NganHang_BaoCo : UserControl
    {
        ...
        private void Load_DaTa(DateTime xxtungay, DateTime  xxdenngay, int bientrangthai)
        {
            ...
            clsNganHang_tbThuChi cls = new GasToanMy.clsNganHang_tbThuChi();
        ...
        private void btThemMoi_Click(object sender, EventArgs e)
        {
            ...
            if (frmQuy_NganHang_Newwwwwwwwwwwwwwwww.miTrangThai_BaoCo1_BaoNo_2_PhieuChi3_PhieuThu4_DoiTien5 == 5)
            {
                ...
                mbCoPy = false;
                mbSua = false;
                QuyNganHang_Frm_DoiTienUSD ff = new GasToanMy.QuyNganHang_Frm_DoiTienUSD();              
                ff.Show();
            ...
            else if (frmQuy_NganHang_Newwwwwwwwwwwwwwwww.miTrangThai_BaoCo1_BaoNo_2_PhieuChi3_PhieuThu4_DoiTien5 == 6)
            {
                ...
                mbCoPy = false;
                mbSua = false;
                QuyNganHang_Frm_PhieuKeToan ff = new GasToanMy.QuyNganHang_Frm_PhieuKeToan();              
                ff.Show();
            ...
            else
            {
                ...
                mbCoPy = false;
                mbSua = false;
                Quy_nganHang_frmThemMoi_ThuChi_CoNo_Newwwwww ff = new GasToanMy.Quy_nganHang_frmThemMoi_ThuChi_CoNo_Newwwwww();              
                ff.Show();
