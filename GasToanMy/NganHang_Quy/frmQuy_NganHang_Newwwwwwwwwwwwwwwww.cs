...
namespace GasToanMy
{
    public partial class frmQuy_NganHang_Newwwwwwwwwwwwwwwww : Form
    {
        ...
        {
            frmPrint_NguoiKy ff = new GasToanMy.frmPrint_NguoiKy();
            //this.Hide();
            ff.Show();
            //this.Show();
        }
        ...
        {
            frmChiTietBienDongTaiKhoan ff = new GasToanMy.frmChiTietBienDongTaiKhoan();
            //this.Hide();
            ff.Show();
            //this.Show();
        ...
        private void navDoiChieuCongNo_LinkClicked(object sender, NavBarLinkEventArgs e)
        {
            ...
            BanHang_DoiChieu_CongNo_new ff = new GasToanMy.BanHang_DoiChieu_CongNo_new();
            //this.Hide();
            ff.Show();
            //this.Show();
        ...
        private void navDCCN_NCC_LinkClicked(object sender, NavBarLinkEventArgs e)
        {
            ...
            frmMuaHang2222.mbclick_DoiChieuCongNo = false;
            frmQuanLyBanHang.mbclick_DoiChieuCongNo = false;
            MuaHang_DoiChieuCongNo_New ff = new GasToanMy.MuaHang_DoiChieuCongNo_New();
            //this.Hide();
            ff.Show();
            //this.Show();
