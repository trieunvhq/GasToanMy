...
namespace GasToanMy
{
    public partial class frmChiTietNhapXuatTon_MotVatTu_khoBanThanhPham : Form
    {
        ...
        private void Load_Lockup()
        {
            try
            {
                using (clsKhoBTP_tbChiTietNhapKho cls = new GasToanMy.clsKhoBTP_tbChiTietNhapKho())
                {
        ...
        private void LoadDaTa(int xxID_VTHH___, DateTime xxtungay, DateTime xxdenngay)
        {
            try
            {
                ...
                clsKhoBTP_tbChiTietNhapKho cls1 = new GasToanMy.clsKhoBTP_tbChiTietNhapKho();
                ...
                cls1 = new GasToanMy.clsKhoBTP_tbChiTietNhapKho();
