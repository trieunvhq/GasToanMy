    ...
    public partial class KhoBTP_ChiTiet_XuatKho_GapDan : Form
    {
        ...
        private void HienThi_Copy(int iiIDXuatkho)
        {
            try
            {
                ...
                clsGapDan_tbNhapKho cls3 = new GasToanMy.clsGapDan_tbNhapKho();
        ...
        private void TinhToanTHanhPham(int xxID_DMgapdan)
        {
            try
            {
                clsDinhMuc_ChiTiet_DinhMuc_ToGapDan cls = new GasToanMy.clsDinhMuc_ChiTiet_DinhMuc_ToGapDan();
                ...
                cls = new GasToanMy.clsDinhMuc_ChiTiet_DinhMuc_ToGapDan();
        ...
        private void gridNguoiLap_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                clsNhanSu_tbNhanSu cls = new GasToanMy.clsNhanSu_tbNhanSu();
