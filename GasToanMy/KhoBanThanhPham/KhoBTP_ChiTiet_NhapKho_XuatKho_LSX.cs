    ...
    public partial class KhoBTP_ChiTiet_NhapKho_XuatKho_LSX : Form
    {
        ...
        private void Luu_NhapKho_banThanhPham()
        {
            ...
            else
            {
                try
                {
                    ...
                    clsHUU_LenhSanXuat clsxxx = new GasToanMy.clsHUU_LenhSanXuat();
                ...
                try
                {
                    ...
                    for (int i = 0; i < dtmoi.Rows.Count; i++)
                    {
                        ...
                        try
                        {
                            ...
                            clsKhoBTP_tbChiTietNhapKho clschitietnhapkho = new GasToanMy.clsKhoBTP_tbChiTietNhapKho();
        ...
        private void HienThi_SUa_LenhSanXuat(int iiID_lenhSanXuat, string smalenhsanxuat)
        {
            try
            {
                ...
                clsHUU_LenhSanXuat_ChiTietLenhSanXuat cls2 = new GasToanMy.clsHUU_LenhSanXuat_ChiTietLenhSanXuat();
