...
namespace GasToanMy
{
    public partial class frmQuanLyBanHang : Form
    {
        ...
        private void HienThi_Caption()
        {
            ...
            //clsKhoBTP_tbNhapKho cls4 = new GasToanMy.clsKhoBTP_tbNhapKho();
            ...
            //}
            //clsKhoBTP_tbNhapKho cls5 = new GasToanMy.clsKhoBTP_tbNhapKho();
        ...
        private void navCongNo_LinkClicked(object sender, DevExpress.XtraNavBar.NavBarLinkEventArgs e)
        {
            ...
            BanHang_CongNo ff = new GasToanMy.BanHang_CongNo();
            //this.Hide();
            ff.Show();
            //this.Show();
