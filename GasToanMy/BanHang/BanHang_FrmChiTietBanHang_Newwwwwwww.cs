    ...
    public partial class BanHang_FrmChiTietBanHang_Newwwwwwww : Form
    {
        ...
        private void Luu_BienDongTaiKhoan(int xxxxID_BanHang)
        {
            try
            {
                ...
                else
                {
                    ...
                    clsNganHang_ChiTietBienDongTaiKhoanKeToan clsxx = new GasToanMy.clsNganHang_ChiTietBienDongTaiKhoanKeToan();
        ...
        private void HienThi_Sua(int iiID_banHang__)
        {
            try
            {
                ...
                clsBanHang_tbBanHang cls = new GasToanMy.clsBanHang_tbBanHang();
                cls.iID_BanHang = iiID_banHang__;
                ...
                clsNganHang_ChiTietBienDongTaiKhoanKeToan clstaikhoan = new GasToanMy.clsNganHang_ChiTietBienDongTaiKhoanKeToan();
        ...
        private void tinhTongTien(double tongIn)
        {
            ...
            for (int i = 0; i < this.gridview_ChiTietBanHang.RowCount; i++)
            {
                deTOngTienChuaVAT += CheckString.ConvertToDouble_My(this.gridview_ChiTietBanHang.GetRowCellValue(i, "ThanhTien"));
            }
        ...
        private void gridview_ChiTietBanHang_InitNewRow(object sender, InitNewRowEventArgs e)
        {
            _NewRow = true;
        }

        private void gridview_ChiTietBanHang_ValidateRow(object sender, DevExpress.XtraGrid.Views.Base.ValidateRowEventArgs e)
        {
            _NewRow = false;
        }
        ...
        private void linkKeHoachSanXuat_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            try
            {
                ...
                BanHang_FrmThamChieuKeHoachSanXuat ff = new GasToanMy.BanHang_FrmThamChieuKeHoachSanXuat();
                ff.Show();
            }
            catch (Exception ea)
            {
