...
namespace GasToanMy
{
    public partial class frmChiTietNhapKho_DaiLy_Sua : Form
    {
        ...
        private bool Luu_ChiLuu()
        {
            ...
            else
            {
               ...
               // cls1.fSoLuongTonhanhPhamQuyDoi = CheckString.ConvertToDouble_My(txtSoLuongThanhPhamQuyDoi.Text.ToString());
                ...
                clsNganHang_ChiTietBienDongTaiKhoanKeToan cls = new GasToanMy.clsNganHang_ChiTietBienDongTaiKhoanKeToan();
        ...
        private void HienThi_GridControl_Sua()
        {
            ...
            clsDaiLy_tbChiTietNhapKho cls = new GasToanMy.clsDaiLy_tbChiTietNhapKho();
            ...
            clsDinhMuc_tbDM_NguyenPhuLieu cls1 = new GasToanMy.clsDinhMuc_tbDM_NguyenPhuLieu();
        ...
        {
            clsDaiLy_tbNhapKho cls = new GasToanMy.clsDaiLy_tbNhapKho();
            cls.iID_NhapKhoDaiLy = UC_DaiLy_NhapKho_ChoGhiSo.miID_NhapKhoDaiLy;
