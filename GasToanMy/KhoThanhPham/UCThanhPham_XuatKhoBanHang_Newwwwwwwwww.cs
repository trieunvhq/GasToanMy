...
namespace GasToanMy
{
    public partial class UCThanhPham_XuatKhoBanHang_Newwwwwwwwww : UserControl
    {
        ...
        private void Load_DaTa(DateTime xxtungay, DateTime xxdenngay)
        {
            ...
            DataTable dt = cls.SA_NgayThang_(checkDaXuatKho.Checked, xxtungay, xxdenngay);
        ...
        private void checkDaXuatKho_CheckedChanged(object sender, EventArgs e)
        {
            if (isload)
                Load_DaTa(dteTuNgay.DateTime, dteDenNgay.DateTime);
        }
