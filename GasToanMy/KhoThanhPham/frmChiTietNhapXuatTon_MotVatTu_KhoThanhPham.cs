...
namespace GasToanMy
{
    public partial class frmChiTietNhapXuatTon_MotVatTu_KhoThanhPham : Form
    {
        ...
        {
            clsKhoThanhPham_tbChiTietNhapKho cls = new GasToanMy.clsKhoThanhPham_tbChiTietNhapKho();
        ...
        private void LoadDaTa(int xxID_VTHH___, DateTime xxtungay, DateTime xxdenngay)
        {
            ...
            clsKhoThanhPham_tbChiTietNhapKho cls1 = new GasToanMy.clsKhoThanhPham_tbChiTietNhapKho();
            ...
            cls1 = new GasToanMy.clsKhoThanhPham_tbChiTietNhapKho();
