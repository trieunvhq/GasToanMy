...
namespace GasToanMy
{
    public partial class frmChiTietNhapKhoThanhPham_DaNhapKhoTP : Form
    {
        ...
        private void HienThi_GridConTrolt()
        {
            ...
            clsKhoThanhPham_tbChiTietNhapKho cls2 = new GasToanMy.clsKhoThanhPham_tbChiTietNhapKho();
        ...
        {
            clsKhoThanhPham_tbNhapKho cls = new GasToanMy.clsKhoThanhPham_tbNhapKho();
