...
namespace GasToanMy
{
    public partial class frmLuong_ChiTietTraLuong : Form
    {
        ...
        private void HienThi_ALL_DaiLy()
        {
            ...
            clsDaiLy_tbXuatKho cls1 = new GasToanMy.clsDaiLy_tbXuatKho();
        ...
        private void HienThi_ThemMoi()
        {
            ...
            clsTraLuong_new cls = new GasToanMy.clsTraLuong_new();
        ...
        private void Luu_ChiTiet_TraLuong(int xxxID_Traluong)
        {
            ...
            {
                clsTraLuong_ChiTietTraLuong_new cls2 = new GasToanMy.clsTraLuong_ChiTietTraLuong_new();
                string shienthi = "1";
                ...
                for (int i = 0; i < dt_gridcontrol.Rows.Count; i++)
                {
                    ...
                    cls2 = new GasToanMy.clsTraLuong_ChiTietTraLuong_new();
