...
namespace GasToanMy
{
    public partial class frmBangChamCongTrongThang : Form
    {
        ...
        private void btthemmoi_Click(object sender, EventArgs e)
        {
            ...
            SanXuat_frmDanhSachChamCong ff = new GasToanMy.SanXuat_frmDanhSachChamCong();
            ff.Show();
        }
        ...
        {
            clsHUU_CongNhat_ChiTiet_ChamCong cls = new GasToanMy.clsHUU_CongNhat_ChiTiet_ChamCong();
